...
static def_DHelper(J){
  ...
  sword_t simm = (s->isa.instr.j.simm19_12 << 12) | s->isa.instr.j.simm10_1 | \
                  (s->isa.instr.j.simm11 << 11) | (s->isa.instr.j.simm20 << 20);
...
static def_DHelper(B) {
  ...
  sword_t simm = (s->isa.instr.b.simm10_5 << 5) | (s->isa.instr.b.simm4_1) | \
                  (s->isa.instr.b.simm11 << 11) | (s->isa.instr.b.simm12 << 12);
  decode_op_i(s, id_dest, simm << 1, true);
}
